# Global Linearity Study Summary: ardupilot_state_evolution_stabilize_baseline
...
- median_alignment_attitude_ms: 0.2573
- median_alignment_position_ms: 0.4065

## Schema Ranking
- `commands_plus_state_history x selected_state_subset | ols_affine | pooled`: test R2=1.0000, sparsity=1.0000, support=supported
- `commands_plus_state_history x next_raw_state | ols_affine | pooled`: test R2=0.9171, sparsity=0.8980, support=supported
- `full_augmented x next_raw_state | ols_affine | pooled`: test R2=0.9171, sparsity=0.8981, support=supported
- `full_augmented x next_raw_state | lasso_affine | pooled`: test R2=0.9171, sparsity=0.8639, support=supported
- `commands_plus_state_history x next_raw_state | lasso_affine | pooled`: test R2=0.9171, sparsity=0.8686, support=supported
- `full_augmented x next_raw_state | ridge_affine | pooled`: test R2=0.9171, sparsity=0.8981, support=supported
- `commands_plus_state_history x next_raw_state | ridge_affine | pooled`: test R2=0.9171, sparsity=0.8980, support=supported
- `commands_plus_state_history x selected_state_subset | ridge_affine | pooled`: test R2=0.7423, sparsity=1.0000, support=supported
- `full_augmented x selected_state_subset | ols_affine | pooled`: test R2=0.7168, sparsity=1.0000, support=supported
- `full_augmented x selected_state_subset | ridge_affine | pooled`: test R2=0.7084, sparsity=1.0000, support=supported
- `full_augmented x selected_state_subset | lasso_affine | pooled`: test R2=0.0816, sparsity=0.9630, support=unsupported
- `commands_plus_state_history x selected_state_subset | lasso_affine | pooled`: test R2=-0.3618, sparsity=0.9804, support=unsupported
