# Global Linearity Study Summary: ardupilot_state_evolution_guided_nogps_diagnostic
...
- median_alignment_attitude_ms: 0.2040
- median_alignment_position_ms: 0.3067
...
- `commands_plus_state_history x selected_state_subset | lasso_affine | pooled`: test R2=1.0000, sparsity=0.8114, support=partial
- `full_augmented x selected_state_subset | lasso_affine | pooled`: test R2=1.0000, sparsity=0.8274, support=partial
- `commands_plus_state_history x next_raw_state | lasso_affine | pooled`: test R2=0.9126, sparsity=0.4728, support=partial
- `commands_plus_state_history x next_raw_state | ridge_affine | pooled`: test R2=0.9126, sparsity=0.8325, support=partial
- `commands_plus_state_history x next_raw_state | ols_affine | pooled`: test R2=0.9126, sparsity=0.7851, support=partial
- `full_augmented x next_raw_state | lasso_affine | pooled`: test R2=0.9126, sparsity=0.4722, support=partial
- `full_augmented x next_raw_state | ridge_affine | pooled`: test R2=0.9125, sparsity=0.8405, support=partial
- `full_augmented x next_raw_state | ols_affine | pooled`: test R2=0.9125, sparsity=0.7944, support=partial
