...
SKIP_CAPTURE=0
MATRIX_DIR=""
ANALYSIS_CONFIG="${ROOT_DIR}/configs/studies/ardupilot_diagnostic_axis_matrix_analysis.yaml"
ABLATION_PLAN="${ROOT_DIR}/configs/ablations/ardupilot_diagnostic_axis_matrix_balanced.yaml"

usage() {
  cat <<'EOF'
Usage: run_ardupilot_diagnostic_matrix.sh [--vehicle ArduCopter] [--frame quad] [--repeat 1]
